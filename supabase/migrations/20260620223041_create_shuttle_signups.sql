...
BEGIN
  ...
  INSERT INTO public.shuttle_signups (full_name, party_size, arrival_wave, departure_wave, whatsapp_optin, travel_details)
  VALUES (_full_name, _party_size, _arrival_wave, _departure_wave, _whatsapp_optin, _travel_details)
  RETURNING * INTO new_row;
  RETURN new_row;
END;
$$;

GRANT EXECUTE ON FUNCTION public.book_shuttle(text,int,text,text,boolean,text) TO anon, authenticated;
