-- Reset shuttle signups (keep Arthur Landmesser's booking) and switch to per-wave capacity.

DELETE FROM public.shuttle_signups
WHERE full_name <> 'Arthur Landmesser';
