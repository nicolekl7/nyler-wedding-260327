  ...
  return (
    <Layout>
      ...
      <section className="page-section pt-12 md:pt-20 w-[90%] max-w-[1200px] mx-auto text-center">
        <FadeIn>
          <p className="body-editorial mx-auto max-w-3xl text-pretty italic">
            {t.welcome}
          </p>
      ...
      {/* Warm Olive Timeline Section matching requested layout */}
          ...
          <div className="space-y-12 md:space-y-16">
            ...
            <FadeIn delay={50}>
              <div className="grid md:grid-cols-3 gap-4 md:gap-8 pt-6 border-t border-[#fff7f0]/20">
                <div className="italic text-xl md:text-2xl opacity-80">{t.wednesday}</div>
            ...
            <FadeIn delay={100}>
              <div className="grid md:grid-cols-3 gap-4 md:gap-8 pt-6 border-t border-[#fff7f0]/20">
                <div className="italic text-xl md:text-2xl opacity-80">{t.thursday}</div>
                <div className="md:col-span-2 space-y-4 font-body text-sm tracking-wide">
                  <div>
            ...
            <FadeIn delay={150}>
              <div className="grid md:grid-cols-3 gap-4 md:gap-8 pt-6 border-t border-[#fff7f0]/20">
                <div className="italic text-xl md:text-2xl opacity-80">{t.friday}</div>
                <div className="md:col-span-2 space-y-6 font-body text-sm tracking-wide">
                  ...
                  <div className="border-l-2 border-[#fff7f0]/30 pl-4 space-y-2">
                    <h4 className="italic text-base text-[#fff7f0]">
                      {language === "en" ? "The Siena & Chianti Excursion" : "Wycieczka do Sieny i Winnicy"}
                    </h4>
                    <p className="text-xs opacity-75 max-w-xl leading-relaxed">
                      {language === "en"
                  ...
                  {/* Friday Evening Unified Events */}
                  <div className="pt-2 space-y-3 border-t border-[#fff7f0]/10">
                    <div>
                      <span className="font-medium inline-block w-24">7:00 PM</span>
            ...
            <FadeIn delay={200}>
              <div className="grid md:grid-cols-3 gap-4 md:gap-8 pt-6 pb-6 border-t border-b border-[#fff7f0]/20">
                <div className="italic text-xl md:text-2xl opacity-80">{t.saturday}</div>
                <div className="md:col-span-2 space-y-4 font-body text-sm tracking-wide">
                  <div>
                    <span className="font-medium inline-block w-24">8:00 AM</span>
                    <span className="opacity-90">Breakfast (until 10:00 AM)</span>
