...
const strings = {
  ...
  pl: {
    heading: "Pobyt w Borgo Laticastelli",
    intro1: "Borgo Laticastelli jest w całości zarezerwowane dla naszych gości. Jeśli zostajesz z nami, jedzenie i picie przez trzy dni masz zapewnione — żadnych dodatkowych kosztów po przyjeździe.",
    intro2: "Przejrzyj dostępne pokoje poniżej i zarezerwuj swoje miejsce. Pokoje przydzielane są według kolejności zgłoszeń. Prosimy pamiętać, że rezerwacja jest potwierdzona dopiero po otrzymaniu płatności.",
    loading: "Ładowanie pokoi...",
    soldOut: "Wyprzedano",
    left: (n: number) => `Zostało ${n}`,
    selectRoom: "Wybierz ten pokój",
    reserveTitle: (name: string) => `Zarezerwuj ${name}`,
    guestNamesLabel: "Imiona i nazwiska wszystkich gości w tym pokoju",
    guestNamesPlaceholder: "Imię i nazwisko każdego gościa, każda osoba w nowej linii",
    emailLabel: "Adres e-mail",
    emailPlaceholder: "twój@email.com",
    reserving: "Rezerwowanie...",
    claimRoom: "Zarezerwuj ten pokój",
    capacity1: "1 osoba (pojedyncze łóżko)",
    capacity2: "Do 2 osób",
    capacity3: "Do 3 osób",
    capacityN: (n: number) => `Do ${n} osób`,
    errorFillAll: "Proszę wypełnić wszystkie pola",
    errorSoldOut: "Ten typ pokoju właśnie się wyprzedał. Proszę wybrać inny.",
    errorGeneric: "Coś poszło nie tak. Proszę spróbować ponownie.",
  },
};
