...
const strings = {
  ...
  pl: {
    ...
    thankYou: "Dziękujemy",
    stayingOnsiteP1: "Nie możemy się doczekać, żeby świętować z Tobą w Toskanii!",
    stayingOnsiteP2: <>Twój pokój jest oficjalnie zarezerwowany. Aby potwierdzić miejsce, wyślij płatność przez PayPal (Znajomi i rodzina) na{" "}<a href="https://paypal.me/nylerwedding" target="_blank" rel="noopener noreferrer" className="text-foreground font-medium underline underline-offset-4 hover:text-primary transition-colors">@NylerWedding</a>{" "}w ciągu 48&nbsp;godzin. W tytule przelewu podaj imiona i nazwiska wszystkich gości nocujących w pokoju.</>,
    ...
    joiningRoomP1: "Nie możemy się doczekać, żeby świętować z Tobą w Toskanii!",
    joiningRoomP2: "Wszystko gotowe — zanotowaliśmy, że dołączasz do zarezerwowanego pokoju. Nie musisz nic płacić; tym zajmie się osoba rezerwująca pokój.",
    offsiteP1: "Nie możemy się doczekać, żeby świętować z Tobą w Toskanii!",
    offsiteP2: "Wszystko gotowe — zanotowaliśmy, że będziesz nocować poza posiadłością. Cieszymy się, że przyjeżdżasz, i nie możemy się doczekać spotkania!",
    declinedP1: "Bardzo dziękujemy za informację. To dla nas naprawdę wiele znaczy, że znalazłeś/aś czas, żeby odpowiedzieć.",
    declinedP2: "Będzie nam Cię bardzo brakować! Mamy nadzieję, że wkrótce będziemy mogli razem świętować. A zdjęciami podzielimy się na pewno — żebyś mógł/mogła poczuć choć trochę toskańskiej magii razem z nami, nawet z daleka.",
    declinedClose: <>Kochamy Cię,<br />Nicole &amp; Tyler</>,
    italianClose: "Ci vediamo in Italia!",
