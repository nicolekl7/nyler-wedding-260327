...
const strings = {
  ...
  pl: {
    ...
    intro1: "Zarezerwowaliśmy całą posiadłość Borgo Laticastelli wyłącznie dla naszych gości. Dla gości nocujących na miejscu śniadania, kolacje i napoje na wszystkich imprezach są wliczone w cenę.",
    intro2: "Aby rozpocząć, wybierz pokój poniżej lub daj nam znać, że będziesz nocować poza posiadłością.",
    intro3: <><strong>Ceny dotyczą całego pokoju na cały pobyt trzydniowy (16–19 września).</strong></>,
    firstComeNote: <>Pokoje dostępne są na zasadzie pierwszeństwa zgłoszeń.<span className="hidden sm:inline"><br /></span><span className="sm:hidden"> </span>Rezerwacje nieopłacone w ciągu 48&nbsp;godzin zostaną anulowane.</>,
    skipRsvp: "Nie możesz przyjechać? Przejdź od razu do RSVP >",
    skipPayment: "Już wypełniłeś/aś RSVP i wybrałeś/aś pokój? Przejdź od razu do płatności >",
    thankYou: "Dziękujemy",
    stayingOnsiteP1: "Nie możemy się doczekać świętowania razem z Wami w Toskanii!",
    stayingOnsiteP2: <>Twój pokój jest oficjalnie zarezerwowany. Aby potwierdzić rezerwację, prześlij płatność poniżej przez PayPal Friends &amp;&nbsp;Family na{" "}<a href="https://paypal.me/nylerwedding" target="_blank" rel="noopener noreferrer" className="text-foreground font-medium underline underline-offset-4 hover:text-primary transition-colors">@NylerWedding</a>{" "}w ciągu 48&nbsp;godzin. W notatce do płatności podaj imiona i nazwiska wszystkich gości w Twoim pokoju.</>,
    stayingOnsiteP3: <>Możesz też zapłacić przez Venmo na{" "}<a href="https://venmo.com/u/tylermagee" target="_blank" rel="noopener noreferrer" className="text-foreground font-medium underline underline-offset-4 hover:text-primary transition-colors">@tylermagee</a>.</>,
    joiningRoomP1: "Nie możemy się doczekać świętowania razem z Wami w Toskanii!",
    joiningRoomP2: "Wszystko gotowe — odnotowaliśmy, że dołączysz do zarezerwowanego pokoju. Nie musisz dokonywać płatności; zajmie się tym właściciel rezerwacji.",
    offsiteP1: "Nie możemy się doczekać świętowania razem z Wami w Toskanii!",
    offsiteP2: "Wszystko gotowe — odnotowaliśmy, że będziesz nocować poza posiadłością. Bardzo się cieszymy, że przyjeżdżasz, i nie możemy się doczekać spotkania!",
    declinedP1: "Dziękujemy za odpowiedź. To naprawdę wiele dla nas znaczy, że znalazłeś/aś czas, aby nam odpisać.",
    declinedP2: "Będzie nam Ciebie bardzo brakowało! Mamy nadzieję, że wkrótce będziemy mogli świętować razem, a my na pewno podzielimy się wszystkimi zdjęciami, abyś mógł/mogła doświadczyć odrobiny Toskanii z daleka.",
    declinedClose: <>Z dużą miłością,<br />Nicole &amp; Tyler</>,
    italianClose: "Ci vediamo in Italia!",
    payPaypal: (price?: number) => `Zapłać przez PayPal${price ? ` — $${price.toLocaleString()}` : ""}`,
    payVenmo: (price?: number) => `Zapłać przez Venmo${price ? ` — $${price.toLocaleString()}` : ""}`,
  },
};
